...
--
-- Host: localhost
-- Generation Time: Nov 27, 2013 at 07:16 PM
...
INSERT INTO `alquiler` (`id`, `cliente_id`, `renta`, `devolucion`, `deposito`, `comentario`) VALUES
(4, 1, '2013-11-23', '2013-11-25', '50.00', 'alquiler de prueba'),
(5, 1, '2013-11-26', '2013-11-28', '60.00', ''),
(6, 4, '2013-11-26', '2013-11-29', '40.00', '');
...
INSERT INTO `alquiler_equipo` (`alquiler_id`, `equipo_id`) VALUES
(4, 5),
(4, 10),
(4, 14),
(4, 18),
...
(1, 1, 7, 82, 'Diego', 'Paolo', 'Tello', 'Cifuentes', '1989-09-13', 'masculino', '779876546321', '54677428', '', '', '', '', '', 'ninguna', 'ninguna'),
...
INSERT INTO `cliente_viaje` (`cliente_id`, `viaje_id`) VALUES
(1, 1),
(2, 9),
(4, 9);
...
INSERT INTO `cuenta` (`id`, `cliente_id`, `alquiler_id`, `viaje_id`, `tipo_de_pago_id`, `tipo`, `estado`, `monto`) VALUES
(3, 1, 4, NULL, 4, 'alquiler', 'cancelado', '500.00'),
(4, 1, 5, NULL, NULL, 'alquiler', 'pendiente', '600.00'),
(5, 1, NULL, 1, 1, 'viaje', 'cancelado', '800.00'),
(6, 2, NULL, 9, NULL, 'viaje', 'pendiente', '600.00'),
(7, 4, NULL, 9, NULL, 'viaje', 'pendiente', '750.00'),
(8, 4, 6, NULL, NULL, 'alquiler', 'pendiente', '400.00');
...
(4, 1, 1, 6, 'Semuc Champey', '', NULL, NULL);
...
(8, 'Cuerda', 'c3', 0, ''),
(9, 'Cuerda', 'c4', 1, ''),
(10, 'Carpa peque̱a', 'cp1', 1, ''),
(11, 'Carpa peque̱a', 'cp2', 0, ''),
(12, 'Carpa peque̱a', 'cp3', 0, ''),
(13, 'Carpa peque̱a', 'cp4', 1, ''),
(14, 'Carpa grande', 'cg1', 1, ''),
(15, 'Carpa grande', 'cg2', 0, ''),
(16, 'Carpa grande', 'cg3', 0, ''),
...
INSERT INTO `guia_viaje` (`guia_id`, `viaje_id`) VALUES
(2, 1),
(6, 1),
(2, 12),
(4, 12),
...
INSERT INTO `viaje` (`id`, `nombre`, `fecha_salida`, `hora_salida`, `fecha_regreso`, `hora_regreso`, `terminado`) VALUES
(1, 'viaje1 actualizado2', '2013-11-29', '08:00:00', '2013-12-01', '16:00:00', 0),
(2, 'viaje2', '2013-11-21', '00:00:00', '2013-11-24', '12:00:00', 0),
(4, 'viaje3', '2013-11-21', '06:00:00', '2013-11-24', '00:00:00', 0),
(5, 'viaje5', '2013-11-25', '06:00:00', '2013-11-27', '00:00:00', 0),
(9, 'prueba creacion 1', '2013-11-30', '07:00:00', '2013-12-09', '06:00:00', 0),
(10, 'prueba 2', '2013-11-22', '08:00:00', '2013-11-27', '04:00:00', 0),
(12, 'Semuc', '2013-11-30', '06:00:00', '2013-12-01', '22:00:00', 0);
